...
export default function HelpPage() {
    return (
        <div className="sb-page">
            <div className="sb-container max-w-6xl py-6 sm:py-10">
                <div className="space-y-10">
                    <div className="space-y-3 text-center">
                        <h1 className="sb-title text-4xl sm:text-5xl">Help and Support</h1>
                    ...
                    <div className="rounded-xl border border-border/80 bg-card/95 p-6 text-center">
                        <p className="text-sm text-muted-foreground">
